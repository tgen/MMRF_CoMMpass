function plotLinearCNAandAbsBAF(cnaTSV,bafTXT,outName)
...
set (hFig,'color','w');
subplot(2,1,1)
plotLinearAbsBAF(bafFreq(:,3),bafFreq(:,1),unique(bafFreq(:,1))','Absolute B-Allele Frequencies (BAF)',[0 0.4470 0.7410])
subplot(2,1,2)
